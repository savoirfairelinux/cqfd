...
`docker_run_image` (optional): allows specifying a Docker image to pull from a
...
Docker images generated by cqfd will be named `cqfd_$username_$org_$name_$hash`,
